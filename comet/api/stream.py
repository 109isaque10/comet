...
async def stream(
    ...
    async with aiohttp.ClientSession(
        ...
        logger.info(f"Number of torrents before filtering: {len(torrents)}") #25
        ...
        logger.info(f"Number of torrents with 'Domain' key: {len(domain_torrents)}") #0
        ...
        logger.info(f"Number of torrents in torrents_by_hash: {len(torrents_by_hash)}") #9
